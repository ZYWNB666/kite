...
export const resourceCatalog = [
  ...
  },
  {
    ...
    clusterScope: false,
    icon: 'IconNetwork',
    sidebar: { groupKey: 'sidebar.groups.network', order: 5 },
  },
  {
    type: 'endpoints',
    singular: 'endpoint',
    ...
    clusterScope: false,
    icon: 'IconNetwork',
    sidebar: { groupKey: 'sidebar.groups.network', order: 6 },
  },
  {
    type: 'ingressclasses',
    ...
    clusterScope: true,
    icon: 'IconRouter',
    sidebar: { groupKey: 'sidebar.groups.network', order: 7 },
  },
  {
    type: 'gateways',
    singular: 'gateway',
  ...
  },
  {
    ...
    sidebar: { groupKey: 'sidebar.groups.config', order: 4 },
  },
  {
    type: 'limitranges',
    singular: 'limitrange',
    ...
    clusterScope: false,
    icon: 'IconArrowsHorizontal',
    sidebar: { groupKey: 'sidebar.groups.config', order: 5 },
  },
  {
    ...
    clusterScope: true,
    icon: 'IconStack2',
    sidebar: { groupKey: 'sidebar.groups.config', order: 6 },
  },
  {
    type: 'runtimeclasses',
    ...
    clusterScope: true,
    icon: 'IconBox',
    sidebar: { groupKey: 'sidebar.groups.config', order: 7 },
  },
  {
    type: 'leases',
    singular: 'lease',
